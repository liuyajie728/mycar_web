<div id=content>
	...
	<ul class=orders class=list-group>
		<li class=list-group-item><a title="余额 &amp; 充值记录" href="<?php echo base_url('order/recharge') ?>">余额 &amp; 充值记录</a></li>
		<li class=list-group-item><a title="消费订单" href="<?php echo base_url('order') ?>">消费订单</a></li>
	</ul>
</div>
